<x-core::custom-template id="_options-repeater_template">
    <div
        class="line row border-bottom py-3"
        data-option="repeater"
    >
        <div class="col-3">
        ...
        <div class="col-9">
            ...
            <div class="add-new-field">
                <ul class="row list-group field-table-header clearfix">
                    <li class="col-4 list-group-item w-bold">{{ trans('plugins/custom-field::base.form.field_label') }}
                    </li>
                    <li class="col-4 list-group-item w-bold">{{ trans('plugins/custom-field::base.form.field_name') }}
                    </li>
                    <li class="col-4 list-group-item w-bold">{{ trans('plugins/custom-field::base.form.field_type') }}
                    </li>
                </ul>
...
<x-core::custom-template id="_options-defaultvaluetextarea_template">
    <div
        class="line row border-bottom py-3"
        data-option="defaultvaluetextarea"
    >
        <div class="col-3">
            <x-core::form.label class="mb-0">{!! BaseHelper::clean(trans('plugins/custom-field::base.form.default_value')) !!}</x-core::form.label>
            <div class="form-control-plaintext">{!! BaseHelper::clean(trans('plugins/custom-field::base.form.default_value_helper')) !!}</div>
...
<x-core::custom-template id="_options-dateformat_template">
    <div
        class="line row border-bottom py-3"
        data-option="dateformat"
    >
        <div class="col-3">
            <x-core::form.label
                class="mb-0">{{ trans('plugins/custom-field::base.form.date_format') }}</x-core::form.label>
...
<x-core::custom-template id="_options-timeformat_template">
    <div
        class="line row border-bottom py-3"
        data-option="timeformat"
    >
        <div class="col-3">
            <x-core::form.label
                class="mb-0">{{ trans('plugins/custom-field::base.form.time_format') }}</x-core::form.label>
    ...
    <li class="ui-sortable-handle active">
        <div class="field-column">
            ...
            <a
                ...
                title=""
                href="#"
            ><x-core::icon name="ti ti-chevron-down" /></a>
        </div>
                    ...
                    <select class="form-control change-field-type">
                        <optgroup label="{{ trans('plugins/custom-field::base.form.groups.basic') }}">
                            <option
                                value="text"
                                selected="selected"
                            >{{ trans('plugins/custom-field::base.form.types.text') }}</option>
                            <option value="textarea">{{ trans('plugins/custom-field::base.form.types.textarea') }}
                            </option>
                            <option value="number">{{ trans('plugins/custom-field::base.form.types.number') }}
                            </option>
                            <option value="email">{{ trans('plugins/custom-field::base.form.types.email') }}</option>
                            <option value="password">{{ trans('plugins/custom-field::base.form.types.password') }}
                            </option>
                            ...
                            <option value="datetime">{{ trans('plugins/custom-field::base.form.types.datetime') }}
                            </option>
                        ...
                        <optgroup label="{{ trans('plugins/custom-field::base.form.groups.content') }}">
                            <option value="wysiwyg">{{ trans('plugins/custom-field::base.form.types.wysiwyg') }}
                            </option>
                        ...
                        <optgroup label="{{ trans('plugins/custom-field::base.form.groups.choice') }}">
                            <option value="select">{{ trans('plugins/custom-field::base.form.types.select') }}
                            </option>
                            <option value="checkbox">{{ trans('plugins/custom-field::base.form.types.checkbox') }}
                            </option>
                        ...
                        <optgroup label="{{ trans('plugins/custom-field::base.form.groups.other') }}">
                            <option value="repeater">{{ trans('plugins/custom-field::base.form.types.repeater') }}
                            </option>
                        </optgroup>
                    </select>
                </div>
